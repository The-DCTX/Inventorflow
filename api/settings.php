...
if ($method === 'POST') {
    ...
    $allowed = ['app_name', 'app_url', 'theme', 'admin_email', 'mail_from_name', 'smtp_host', 'smtp_port', 'smtp_user', 'smtp_pass', 'smtp_from', 'smtp_from_name', 'notif_backup_error', 'backup_kw_success', 'backup_kw_failure'];
    ...
    session_write_close(); // Force session flush before reload
